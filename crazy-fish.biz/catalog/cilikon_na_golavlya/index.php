...
$APPLICATION->SetPageProperty("description", "Лучшие силиконовые приманки НА ГОЛАВЛЯ от официального производителя Crazy Fish недорого! Низкие цены, большой выбор, доставка по территории России ✓ Всё, что нужно для хорошей рыбалки ✈ Доставим быстро");
$APPLICATION->SetTitle("Силикон на голавля");
$APPLICATION->SetPageProperty("title", "Купить Силиконовые приманки НА ГОЛАВЛЯ от Crazy Fish | Официальный интернет-магазин");
?>
<h1>Силикон на голавля</h1>
<?
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"OR\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:447\",\"DATA\":{\"logic\":\"Equal\",\"value\":431}}]}",
		"DETAIL_URL" => "",
