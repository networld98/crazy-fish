...
$APPLICATION->SetPageProperty("description", "Лучшие силиконовые приманки НА МИРНУЮ РЫБУ от официального производителя Crazy Fish недорого! Низкие цены, большой выбор, доставка по территории России  ✓ Всё, что нужно для хорошей рыбалки ✈ Отправляем ВСЕМ!");
$APPLICATION->SetTitle("Силикон на мирную рыбу");
$APPLICATION->SetPageProperty("title", "Купить Силиконовые приманки НА МИРНУЮ РЫБУ от Crazy Fish | Официальный интернет-магазин");
?>
<h1>Силикон на мирную рыбу</h1>
<?
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"OR\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:447\",\"DATA\":{\"logic\":\"Equal\",\"value\":429}}]}",
		"DETAIL_URL" => "",
