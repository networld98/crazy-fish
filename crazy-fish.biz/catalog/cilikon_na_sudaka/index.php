...
$APPLICATION->SetPageProperty("description", "Лучшие спиннинги НА СУДАКА от официального производителя Crazy Fish недорого! Низкие цены, большой выбор, доставка по территории России  ✓ Всё, что нужно для хорошей рыбалки ✈ ОТПРАВЛЯЕМ!");
$APPLICATION->SetTitle("Силикон на судака");
$APPLICATION->SetPageProperty("title", "Купить Силиконовые приманки НА СУДАКА от Crazy Fish | Официальный интернет-магазин");
?>
<h1>Силикон на судака</h1>
<?
