...
$APPLICATION->SetTitle("Cпиннинги для дальнего заброса");
$APPLICATION->SetPageProperty("title", "Купить спиннинги для дальнего заброса от Crazy Fish | Официальный интернет-магазин ");
?>
<h1>Спиннинги для дальнего заброса</h1>
<?
