...
$APPLICATION->SetPageProperty("description", "Лучшие спиннинги для ТВИЧИНГА от Crazy Fish! ✓ Низкие цены от производителя! ✓ Всё, что нужно для хорошей рыбалки ✈ Быстрая отгрузка");
$APPLICATION->SetTitle("Спиннинги для твичинга");
$APPLICATION->SetPageProperty("title", "Купить спиннинги для твичинга от Crazy Fish | Официальный интернет-магазин - Москва, СПб");
?>
<h1>Спиннинги для твичинга</h1>
<?
