...
$APPLICATION->SetPageProperty("description", "Лучшие спиннинги НА СОМА от официального производителя Crazy Fish недорого! Низкие цены, большой выбор, доставка по территории России  ✓ Всё, что нужно для хорошей рыбалки ✈ Мгновенная отгрузка");
$APPLICATION->SetTitle("Спиннинг на мирную рыбу");
$APPLICATION->SetPageProperty("title", "Купить спиннинг на сома от Crazy Fish | Официальный интернет-магазин производителя");
?>
<h1>Спиннинг на мирную рыбу</h1>
<?
