...
$APPLICATION->SetPageProperty("description", "Наноджиг с Crazy Fish - это поклевка с первого заброса! Лучшие спиннинги для наноджига - модели от украинского производителя. Официальный интернет-магазин ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Купить спиннинги для наноджига от Crazy Fish | Официальный интернет-магазин России - цены, отзывы");
?><h1>Спиннинги для наноджига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":365}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Спиннинги CRAZY FISH\"}}]}",
		"DETAIL_URL" => "",
