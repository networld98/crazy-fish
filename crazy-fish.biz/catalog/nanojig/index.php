...
$APPLICATION->SetPageProperty("description", "В нашем каталоге доступны приманки Crazy Fish для наноджига – Доставка по всей территории РФ. Официальный сайт с оригинальной продукцией ✓ Большой ассортимент ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Купить уловистые снасти и приманки для наноджига по низкой цене | Crazy Fish");
?><h1>Снасти и приманки для наноджига</h1>
<?
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "EDIT_TEMPLATE" => "",
        "PATH" => SITE_DIR . "/catalog/nanojig/filter.php",
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":365}}]}",
		"DETAIL_URL" => "",
 ...
 <br>
<p>
	 Спиннинговые снасти уже давно идут по пути минимализма, именно поэтому Crazy Fish совершенствует продукцию, уменьшая размеры и вес приманок. Рыба становится осторожнее, в результате чего приходится ухитряться, чтобы вернуться с уловом. <b>Наноджиг</b> – именно тот тип джиговой ловли, который предполагает использование микро приманок и снастей. Рыба принимает эти сверхмалые приманки даже тогда, когда микроджиг не срабатывает. Примечательные особенности продукции – это:
</p>
<p>
	 ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Уникальная узкоспециализированная оснастка;
</p>
<p>
	 ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Доступная стоимость;
</p>
...
<p>
	 ·&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Постоянная модернизация моделей для улучшения показателей уловистости.
</p>
<p>
	 В этом разделе каталога представлены снасти для наноджига, которые гарантируют поклевку с первого заброса! Украинский производитель позаботился об ассортименте приманок. Crazy Fish предлагает рабочие вольфрамовые грузы, крючки и спиннинги по доступной цене. Это та продукция, которая разрабатывалась экспертами и спортсменами. Это те модели, которые уже были протестированы опытными и начинающими спиннингистами.
</p>
 <br>
