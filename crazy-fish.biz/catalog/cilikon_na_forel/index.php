...
$APPLICATION->SetTitle("Силикон на форель");
$APPLICATION->SetPageProperty("title", "Купить Силикон на сома от Crazy Fish | Официальный интернет-магазин производителя");
?>
<h1>Силикон на форель</h1>
<?
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"OR\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:447\",\"DATA\":{\"logic\":\"Equal\",\"value\":430}}]}",
		"DETAIL_URL" => "",
