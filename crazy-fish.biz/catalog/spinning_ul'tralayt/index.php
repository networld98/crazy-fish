...
$APPLICATION->SetTitle("Спиннинг ультралайт");
$APPLICATION->SetPageProperty("title", "Купить спиннинги ультралайт от Crazy Fish | Интернет-магазин в Москве, СПб, РФ");
$APPLICATION->SetPageProperty("description", "Лучшие спиннинги для УЛЬТРАЛАЙТовой ловли! Официальный сайт  Crazy Fish! Низкие цены, большой выбор, доставка по всей России  ✓ Всё для хорошей рыбалки! ✈ Быстрая отгрузка");
?>
<h1>Спиннинг ультралайт</h1>
<?
