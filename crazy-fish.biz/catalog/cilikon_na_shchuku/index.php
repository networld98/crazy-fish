...
$APPLICATION->SetPageProperty("description", "Лучшие силиконовые приманки НА ЩУКУ от официального производителя Crazy Fish недорого! Низкие цены, большой выбор, доставка по территории России  ✓ Всё, что нужно для хорошей рыбалки ✈ БЫСТРО ДОСТАВИМ!");
$APPLICATION->SetTitle("Силикон на щуку");
$APPLICATION->SetPageProperty("title", "Купить Силиконовые приманки НА ЩУКУ от Crazy Fish | Официальный интернет-магазин");
?>
<h1>Силикон на щуку</h1>
<?
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"OR\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:447\",\"DATA\":{\"logic\":\"Equal\",\"value\":427}}]}",
		"DETAIL_URL" => "",
