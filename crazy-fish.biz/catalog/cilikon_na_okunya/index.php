...
$APPLICATION->SetPageProperty("description", "Лучшие силиконовые приманки НА ОКУНЯ от официального производителя Crazy Fish недорого! Низкие цены, большой выбор, доставка по территории России ✓ Всё, что нужно для хорошей рыбалки ✈");
$APPLICATION->SetTitle("Силикон на окуня");
$APPLICATION->SetPageProperty("title", "Купить силиконовые приманки НА ОКУНЯ от Crazy Fish | Официальный интернет-магазин производителя");
?>
<h1>Силикон на окуня</h1>
<?
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"OR\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:447\",\"DATA\":{\"logic\":\"Equal\",\"value\":426}}]}",
		"DETAIL_URL" => "",
