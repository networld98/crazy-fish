...
$APPLICATION->SetTitle("Бесконтактная доставка Crazy Fish - Россия, Москва");
?><h1>Товары с бесконтактной доставкой</h1>
<h3>Курьер привезет оплаченный заказ до двери, позвонит и отойдет на 2-3 метра. Вы сможете всё проверить и подтвердить получение.</h3>
