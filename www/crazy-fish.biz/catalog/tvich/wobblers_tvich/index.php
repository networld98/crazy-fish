...
$APPLICATION->SetPageProperty("description", "Твичинг с Crazy Fish - это поклевка с первого заброса! Воблеры для твича (твичинга). Официальный интернет-магазин производителя оснастки ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Воблеры для твича (твичинга) от Crazy Fish | Интернет-магазин в России - цены, отзывы ");
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Воблеры\"}},{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":370}}]}",
		"DETAIL_URL" => "",
