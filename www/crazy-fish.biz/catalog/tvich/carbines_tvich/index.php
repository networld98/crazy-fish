...
$APPLICATION->SetPageProperty("description", "Твичинг с Crazy Fish - это поклевка с первого заброса! Карабины, поводок струна с вертлюгом для твича (твичинга) от официального производителя по выгодной стоимости ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Карабины, поводок струна с вертлюгом для твича (твичинга) от Crazy Fish ");
?><h1>Карабины для твича</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":370}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Карабины, ретриверы, вертлюги\"}}]}",
		"DETAIL_URL" => "",
