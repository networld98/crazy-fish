...
$APPLICATION->SetPageProperty("description", "Твичинг с Crazy Fish - это поклевка с первого заброса! ТОПовые модели спиннингов для твичинка в нашем магазине - Официальный украинский производитель ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Спининги для твичинга (твича) от Crazy Fish | Интернет-магазин производителя - цены, отзывы");
?><h1>Спиннинги для твича</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":370}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Спиннинги CRAZY FISH\"}}]}",
		"DETAIL_URL" => "",
