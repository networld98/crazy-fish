...
<p>Открыть на сайте #LINK#</p>",
		"FORM_MESS_ADD_REVIEW_EVENT_THEME" => "Отзыв в магазине crazy-fish.biz (оценка: #RATING#) ##ID#",
...
К Вашему отзыву добавлен официальный ответ, для просмотра перейдите по ссылке #LINK#",
		...
		"LIST_SET_TITLE" => "N",
		"LIST_SHOP_NAME_REPLY" => "Интернет-магазин crazy-fish.biz",
		"LIST_SHOW_THUMBS" => "Y",
