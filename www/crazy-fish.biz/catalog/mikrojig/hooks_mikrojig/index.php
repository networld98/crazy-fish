...
$APPLICATION->SetPageProperty("description", "Микроджиг с Crazy Fish - Офсетные крючки для микроджига, с большим ушком от украинского производителя! Официальный интернет-магазин ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Офсетные крючки для микроджига, с большим ушком от Crazy Fish | Официальный интернет-магазин России - цены, отзывы");
?><h1>Крючки для микроджига</h1>
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":366}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Крючки Crazy Fish\"}}]}",
		"DETAIL_URL" => "",
