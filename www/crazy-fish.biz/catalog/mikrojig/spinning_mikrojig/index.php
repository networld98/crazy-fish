...
$APPLICATION->SetPageProperty("description", "Микроджиг с Crazy Fish - это поклевка с первого заброса! Предлагаем лучшие спиннинги для микроджина от производителя - Официальный интернет-магазин ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Спиннинги для микроджига от Crazy Fish | Интернет-магазин в России - цены, отзывы");
?><h1>Спиннинги для микроджига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":366}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Спиннинги CRAZY FISH\"}}]}",
		"DETAIL_URL" => "",
