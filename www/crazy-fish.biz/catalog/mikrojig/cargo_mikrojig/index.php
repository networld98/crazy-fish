...
$APPLICATION->SetPageProperty("description", "Микроджиг с Crazy Fish - Лучшие грузы для микроджига! Официальный производитель оснастки для рыбалки - Интернет-магазин в России ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Грузы для микроджига - чебурашка и др. от Crazy Fish | Россия - цены, отзывы");
?><h1>Груза для микроджига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":366}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Груза Crazy Fish\"}}]}",
		"DETAIL_URL" => "",
