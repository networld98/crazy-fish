...
$APPLICATION->SetPageProperty("description", "Лучший ДЖИГ со спиннингами от Crazy Fish! ✓ Низкие цены от производителя! ✓ Большой выбор, доставка по России  ✓ Всё, что нужно для хорошей рыбалки ✈ Быстрая отгрузка");
$APPLICATION->SetTitle("Спиннинг для джига");
$APPLICATION->SetPageProperty("title", "Купить спиннинги для джига от Crazy Fish | Официальный интернет-магазин Москва, СПб");
?>
<h1>Спиннинг для джига</h1>
<?
