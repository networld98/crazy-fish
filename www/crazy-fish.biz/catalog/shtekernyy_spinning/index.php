...
$APPLICATION->SetPageProperty("description", "ШТЕКЕРНЫЕ спиннинги от Crazy Fish, которые ЛОВЯТ! Низкие цены в интернет-магазине официального ПРОИЗВОДИТЕЛЯ ✓ Всё, что нужно для хорошей рыбалки ✈ Быстрая отгрузка");
$APPLICATION->SetTitle("Штекерный спиннинг");
$APPLICATION->SetPageProperty("title", "Купить штекерные спиннинги Crazy Fish в официальном интернет-магазине производителя | Москва, СПб, цена");
?>
<h1>Штекерный спиннинг</h1>
<?
