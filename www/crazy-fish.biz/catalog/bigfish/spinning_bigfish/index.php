...
$APPLICATION->SetPageProperty("description", "Биг Фишинг со спинингами от  Crazy Fish: серьезная охота на трофей! Все для успешной рыбалки ✈ Быстрая отгрузка \$ Лучшие цены и модели");
$APPLICATION->SetTitle("Спининги для бигфиша от Crazy Fish | Официальный интернет-магазин России - цены, отзывы");
?><h1>Спиннинги для бигфиша</h1>
<?
