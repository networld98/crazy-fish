...
$APPLICATION->SetPageProperty("description", "Биг Фишинг с катушками и шпулями от Окума (Okuma) и Дайва (Daiwa) : ловим трофей! Все товары на биг фиш - на окуня, щуку, судака и других хищников. Все для УЛОВИСТОЙ рыбалки ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Катушки и шпули для бигфиша Окума (Okuma) и Дайва (Daiwa) | Wены, отзывы");
?><h1>Катушки для бигфиша</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":368}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Катушки\"}}]}",
		"DETAIL_URL" => "",
