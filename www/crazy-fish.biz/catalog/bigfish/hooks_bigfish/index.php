...
$APPLICATION->SetPageProperty("description", "Биг Фишинг с Crazy Fish: лучшие офсетные крючки для серьезной охоты на трофей! Товары для биг фиша - резина на окуня, щуку, судака и других хищников. ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Крючки офсетные для бигфиша от Crazy Fish | ТОПовый производитель - цены, отзывы");
?><h1>Крючки для бигфиша</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":368}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Крючки Crazy Fish\"}}]}",
		"DETAIL_URL" => "",
