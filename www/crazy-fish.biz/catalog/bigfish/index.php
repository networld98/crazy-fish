...
$APPLICATION->SetTitle("Снасти для Биг Фиша от официального производителя Crazy Fish - Россия, Москва");
?><h1>Снасти и приманки для биг фиша</h1>
<?
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "EDIT_TEMPLATE" => "",
        "PATH" => SITE_DIR . "/catalog/bigfish/filter.php",
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":368}}]}",
		"DETAIL_URL" => "",
 ...
 <br>
<p>
	 Чтобы поймать трофей,&nbsp;опытным рыбакам приходится не только изучать повадки рыбы и водоема. Охота на крупный экземпляр подразумевает использование соответствующей оснастки. Именно удачно подобранная снасть поможет спровоцировать гиганта на поклевку.
</p>
<p>
	 При «биг фишинге» следует отказаться от ловли «мелочи» - с небольшими приманками шанс поимки крупной рыбы будет запредельно низким. Победа в данном виде спорта требует не только терпения, но и грамотной подготовки! Для того чтобы ваша охота была успешной, наша команда экспертов потрудилась над разработкой узкоспециализированной оснастки для вашего «биг фиша». Особенности продукции:
</p>
<p>
</p>
<ul>
	<li>
	<p>
		 Соответствие оснастки специфике водоемов России;
	</p>
 </li>
	<li>
	<p>
		 Мощные модели, которые выдержат крупный экземпляр;
	</p>
 </li>
	<li>
	<p>
	...
	<li>
	<p>
		 Постоянная модернизация продукции с целью улучшения ее уловистости.
	</p>
 </li>
</ul>
<p>
...
<p>
	 Существует множество легенд и историй о тактиках выжидания, характере анимации и анализе поведения гигантов. Но, как бы там ни было, справиться с поимкой крупной особи будет непросто – для этого понадобится не только терпение, но и специальная мощные <b>снасти для "биг фиша" от Crazy Fish!</b>
</p>
 <br>
