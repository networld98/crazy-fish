...
$APPLICATION->SetPageProperty("description", "Спиннинги для начинающих, которые ловят! Продукция от популярного бренда Crazy Fish! Официальный интернет-магазин производителя ✓ Всё, что нужно для хорошей рыбалки ✈ Быстрая отгрузка");
$APPLICATION->SetTitle("Спиннинги для начинающих");
$APPLICATION->SetPageProperty("title", "Купить спиннинги для начинающих от Crazy Fish - Для новичков | Официальный интернет-магазин");
?>
<h1>Спиннинги для начинающих</h1>
<?
