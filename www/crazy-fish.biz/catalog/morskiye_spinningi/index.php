...
$APPLICATION->SetPageProperty("keywords", "Специализированные МОРСКИЕ спиннинги от Crazy Fish, которые ловят! Официальный интернет-магазин производителя ✓ Всё, что нужно для хорошей рыбалки ✈ Быстрая доставка по России");
$APPLICATION->SetTitle("Морские спиннинги");
$APPLICATION->SetPageProperty("title", "Купить морские спиннинги от Crazy Fish | Официальный сайт - цены");
?>
<h1>Морские спиннинги</h1>
<?
