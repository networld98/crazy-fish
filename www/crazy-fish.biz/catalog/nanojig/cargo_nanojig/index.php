...
$APPLICATION->SetPageProperty("description", "Наноджиг с вольфрамовыми грузами от Crazy Fish - это поклевка с первого заброса! ТОПовый интернет-магазин украинского производителя ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Купить груза вольфрамовые для наноджига от Crazy Fish недорого | Интернет-магазин в России - цены, отзывы");
?><h1>Груза для наноджига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":365}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Груза Crazy Fish\"}}]}",
		"DETAIL_URL" => "",
