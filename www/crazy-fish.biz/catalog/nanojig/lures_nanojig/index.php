...
$APPLICATION->SetPageProperty("description", "Лучшие силиконовые приманки для наноджиговой ловли! Официальный интернет-магазин украинского производителя Crazy Fish ✈ Быстрая отгрузка \$ Бюджетные цены");
$APPLICATION->SetTitle("Уловистые силиконовые приманки для наноджига от Crazy Fish - Купить в интернет-магазине - Цены, отзывы");
?><h1>Приманки для наноджига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Cиликон Crazy Fish\"}},{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":365}}]}",
		"DETAIL_URL" => "",
