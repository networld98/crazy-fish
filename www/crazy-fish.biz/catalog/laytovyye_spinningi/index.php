...
$APPLICATION->SetPageProperty("description", "ЛАЙТОВЫЕ спиннинги от CRAZY FISH, которые ловят! Модели от ТОПового бренда. Официальный интернет-магазин ✓ Всё, что нужно для хорошей рыбалки ✈ Быстрая отправка");
$APPLICATION->SetTitle("Лайтовые спиннинги");
$APPLICATION->SetPageProperty("title", "Купить лайтовые спиннинги от Crazy Fish | Интернет-магазин производителя в Москве, РФ");
?>
<h1>Лайтовые спиннинги</h1>
<?
