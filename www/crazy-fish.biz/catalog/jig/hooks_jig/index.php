...
$APPLICATION->SetPageProperty("description", "Большой выбор крючков для джига - офсетные крючки для джиг-головок! Официальный интернет-магазин производителя ✈ Быстрая отгрузка \$ ДОСТУПНЫЕ цены");
$APPLICATION->SetTitle("Офсетные крючки для джига (джиг-головок) - от Crazy Fish | Россия - цены, отзывы");
?><h1>Крючки для джига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":{\"0\":{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":369}},\"2\":{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Крючки Crazy Fish\"}}}}",
		"DETAIL_URL" => "",
