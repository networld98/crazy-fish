...
$APPLICATION->SetPageProperty("description", "Джиговые катушки на официальном интернет-магазине Crazy Fish! Поклевка с первого заброса. Выгодные цены на сайте производителя снастей и приманок ✈ Быстрая отгрузка");
$APPLICATION->SetTitle("Лучшие катушки для джига (джиговые) - Daiwa (Дайва), Okuma (Окума) | Цены, отзывы");
?><h1>Катушки для джига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":369}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Катушки\"}}]}",
		"DETAIL_URL" => "",
