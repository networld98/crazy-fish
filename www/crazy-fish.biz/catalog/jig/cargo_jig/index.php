...
$APPLICATION->SetPageProperty("description", "Джиг с Crazy Fish - это поклевка с первого заброса! Джиговые грузы по СУПЕР цене от официального производителя! ТОПовый интернет-магазин ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Грузы для джига, джиг-рига от Crazy Fish | Официальный интернет-магазин - цены, отзывы");
?><h1>Груза для джига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":369}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Груза Crazy Fish\"}}]}",
		"DETAIL_URL" => "",
