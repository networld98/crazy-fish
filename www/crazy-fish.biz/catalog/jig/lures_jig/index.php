...
$APPLICATION->SetPageProperty("description", "Приобрести силикон для ловли джигом от Crazy Fish - Приманки на окуня, щуку, судака и других хищников. Официальный интернет-магазин ✈ Быстрая доставка по России \$ Лучшие цены");
$APPLICATION->SetTitle("Приманки для джига (силиконовые) на щуку, окуня и др. от Crazy Fish | Цены, отзывы");
?><h1>Приманки для джига</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":{\"0\":{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":369}},\"2\":{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Cиликон Crazy Fish\"}}}}",
		"DETAIL_URL" => "",
