...
$APPLICATION->SetPageProperty("description", "Спиннинги для ТРОЛЛИНГА от Crazy Fish, которые ЛОВЯТ!  --> Выгодные цены на сайте производителя --> Большой выбор, доставка по всей России  ✓ Всё, что нужно для хорошей рыбалки ✈ Быстрая отгрузка");
$APPLICATION->SetTitle("Спиннинг для троллинга");
$APPLICATION->SetPageProperty("title", "Купить спиннинги для троллинга от Crazy Fish | Официальный интернет-магазин производителя");
?>
<h1>Спиннинг для троллинга</h1>
<?
