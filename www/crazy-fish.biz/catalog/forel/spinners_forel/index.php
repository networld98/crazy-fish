...
$APPLICATION->SetPageProperty("description", "Уловистые блесны на форель от Crazy Fish - Официальный интернет-магазин украинского производителя ✈ Быстрая отгрузка и доставка по всем регионам страны  \$ Лучшие цены");
$APPLICATION->SetTitle("Купить блесну для ловли форели от Crazy Fish | Официальный интернет-магазин России - цены, отзывы");
?><h1>Блесны для форели</h1>
<?
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Блесны Crazy Fish\"}},{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":367}}]}",
		"DETAIL_URL" => "",
