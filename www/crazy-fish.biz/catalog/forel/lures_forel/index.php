...
$APPLICATION->SetPageProperty("description", "Лучшие приманки из силикона на форель от Crazy Fish - это поклевка с первого заброса! Широкий ассортимент, ТОПовые модели - Официальный интернет-магазин производителя ✈ Быстрая отгрузка \$ Лучшие цены");
$APPLICATION->SetTitle("Купить силиконовые приманки для форели от Crazy Fish | Цены, отзывы");
?><h1>Приманки для форели</h1>
<?
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "EDIT_TEMPLATE" => "",
        "PATH" => SITE_DIR . "/catalog/forel/filter.php",
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Cиликон Crazy Fish\"}},{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":367}}]}",
		"DETAIL_URL" => "",
 ...
 <br>
<p>
	 Для любителей микроджиговой ловли хищной рыбы Crazy Fish подготовил супер уловистые приманки и снасти! Подходящие цвета, баланс веса и размера позволяют создать беспроигрышную игру в глазах хищника. В этом разделе каталога вы сможете найти лучшие снасти для форели от полюбившегося украинского бренда-производителя.&nbsp;<b>Оснастка для форели от Crazy Fish </b>разрабатывалась с участием экспертов и авторитетных рыболовов страны. Приманки и другие снасти, представленные на этой странице, обеспечат:
</p>
<p>
</p>
<ul>
