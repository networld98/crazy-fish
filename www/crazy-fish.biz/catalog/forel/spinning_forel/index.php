...
$APPLICATION->SetPageProperty("description", "Лучшие спиннинги на форель от украинского производителя Crazy Fish - поклевка с первого заброса! Официальный интернет-магазин ✈ Быстрая отгрузка \$ Бюджетные цены");
$APPLICATION->SetTitle("Купить спиннинги для форели от Crazy Fish - Лучшие модели - ТОП! | Официальный интернет-магазин России - цены, отзывы");
...
<div id="catalog-filter">
	...
	array(
		...
		"COMPOSITE_FRAME_TYPE" => "AUTO",
		"CONVERT_CURRENCY" => "N",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"AND\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBProp:44:419\",\"DATA\":{\"logic\":\"Equal\",\"value\":367}},{\"CLASS_ID\":\"CondIBProp:44:371\",\"DATA\":{\"logic\":\"Equal\",\"value\":\"Спиннинги CRAZY FISH\"}}]}",
		"DETAIL_URL" => "",
